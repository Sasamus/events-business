...
public class DatabaseManager {
	...
	public void readData() {
		...
		InputStream inputStream = DatabaseManager.class.getResourceAsStream("/Resources/events.txt"); 
			...
			if(line.equals("Users:")){
				while (scanner.hasNextLine()) {
					...
					if(line.isEmpty()){
						...
						InputStream imageInputStream = DatabaseManager.class.getResourceAsStream("/Resources/MissingPicture.jpg"); 
