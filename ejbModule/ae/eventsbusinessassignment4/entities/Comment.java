...
public class Comment extends EntitySuperClass {
	...
	/**
	 * @param event The Event the comment is for
	 * @param user The user than made the comment
	 * @param comment The comment itself
	 * @param submissionTime Time the comment was submitted
	 * @param lastUpdateTime Time the comment was updated
	 */
	public Comment(Event event, User user, String comment, Timestamp submissionTime, Timestamp lastUpdateTime) {
		this.event = event;
		this.user = user;
	...
	/**
	 * @param time the most recent update time
	 */
